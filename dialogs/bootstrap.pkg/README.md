...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00007/jquery.dirtyforms.dialogs.bootstrap.min.js"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/g/jquery@1.11.3,bootstrap@3.0.0,jquery.dirtyforms@2.0.0-beta00007(jquery.dirtyforms.min.js+jquery.dirtyforms.dialogs.bootstrap.min.js)"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00007/jquery.dirtyforms.dialogs.bootstrap.min.js.map"></script>
```
...
<script src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00007/jquery.dirtyforms.dialogs.bootstrap.min.js" type="text/javascript"></script>
```
