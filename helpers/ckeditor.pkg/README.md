...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.ckeditor.min.js"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.ckeditor.min.js.map"></script>
```
...
<script src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.ckeditor.min.js" type="text/javascript"></script>
```
