...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00001/jquery.dirtyforms.helpers.ckeditor.min.js"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/g/jquery@1.11.3,jquery.facebox,ckeditor(ckeditor.js),jquery.dirtyforms@2.0.0-beta00001(jquery.dirtyforms.min.js+jquery.dirtyforms.helpers.ckeditor.min.js)"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00001/jquery.dirtyforms.helpers.ckeditor.min.js.map"></script>
```
...
<script src="//cdn.jsdelivr.net/jquery.dirtyforms/2.0.0-beta00001/jquery.dirtyforms.helpers.ckeditor.min.js" type="text/javascript"></script>
```
