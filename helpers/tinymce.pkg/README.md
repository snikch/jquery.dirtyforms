...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.tinymce.min.js"></script>
```
...
```HTML
<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.tinymce.min.js.map"></script>
```
...
<script src="//cdn.jsdelivr.net/jquery.dirtyforms/1.0.0/jquery.dirtyforms.helpers.tinymce.min.js" type="text/javascript"></script>
```
